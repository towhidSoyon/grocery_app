...
import 'package:grocery_app/features/authentication/controllers/login/login_controller.dart';
                      ...
                      children: [
                        Row(
                          children: [
                            Obx(
                              () =>
                                  Checkbox(value: controller.rememberMe.value, onChanged: (value) => controller.rememberMe.toggle()),
                            ),
